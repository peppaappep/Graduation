...
(function(mod) {
  ...
  CodeMirror.registerHelper("hint", "python", function(cm, options) {
    ...
    var words = (CodeMirror.tableKeywords || {})[cm.getTokenAt({ch: cur.ch - (term.length + 1), line: cur.line, sticky: cur.sticky}).string] || (cm.keywords && cm.keywords.split(' ')) ||cm.getHelper(cm.getCursor(), "hintWords");
    var found = [];
