...
(function(dsfa) {
    ...
    dsfa.Flow = function(options) {
        var self = this;
        //var currentJoinLineInfo = null;
        //var currentFromLineInfo=null;
        ...
        this.currentCommand = "";
        // this.nodeAttr = options.nodeAttr || {};
        // this.lineAttr = options.lineAttr || {};
        // this.flowAttr = options.flowAttr || {};
        // this.laneAttr = options.laneAttr || {};
        this.Lanes = {
            "vertical": [],
            "horizontal": []
        }
        ...
        this.init = function() {
            ...
            //self.on("node.editNameAfter",defaultHandler.editNameAfter)
        ...
        var attachEvents = function() {
            ...
            //拖动节点
            //this.root.on("mousedown", ".node,.nodeOuter", nodeMouseDownHandler);
            //鼠标移动过程中的操作
            ...
            //鼠标拖动线
            //this.root.on("mousedown.dragline", "path", lineMouseDownHandler);
        ...
        var _command = {
            ...
            "addNode": function(opts) {
                ...
                //var nodeType = nodeTypeInfo[options.type];
                //options.img = nodeType.img;
    ...
    DSFA.Lane = function(flow, opt) {
        ...
        this.render = function() {
            if (!this.isRender) {
                ...
                var plus_left = $("<img class='plus left' src='../res/imgs/plus.png'/>").appendTo(title);
                var plus_right = $("<img class='plus right' src='../res/imgs/plus.png'/>").appendTo(title);
